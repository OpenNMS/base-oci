...
LABEL org.opencontainers.image.created="${BUILD_DATE}" \
      ...
      org.opennme.cicd.jobid="${CIRCLE_WORKFLOW_JOB_ID}" \
      org.opennms.cicd.buildnumber="${CIRCLE_BUILD_NUM}" \
      org.opennms.cicd.buildurl="${CIRCLE_BUILD_URL}" \
      org.opennms.cicd.branch="${CIRCLE_BRANCH}"
