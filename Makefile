...
DOCKER_FLAGS       := --output=type=docker,dest=artifacts/image.oci
...
help:
	...
	@echo "  DOCKER_INSTANCE:    Name of the docker buildx instance, default: $(DOCKER_INSTANCE)"
	...
	@echo "  DOCKER_FLAGS:       Additional docker-buildx flags."
	@echo ""
	@echo "Example:"
	@echo ""
